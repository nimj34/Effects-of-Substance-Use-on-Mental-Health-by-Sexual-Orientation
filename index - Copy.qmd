...
```{r}
rm(age_freq_table)
rm(alc30use_freq_table)
rm(alcbinge30_freq_table)
rm(alcdisorder_year_freq_table)
rm(cig30use_freq_table)
rm(majordepressive_year_freq_table)
rm(mj30use_freq_table)
rm(mjdisorder_year_freq_table)
rm(nicdepend_freq_table)
rm(psych_distress_30_freq_table)
rm(sex_freq_table)
rm(sex_orient_freq_table)
rm(suicide_freq_table)
```
